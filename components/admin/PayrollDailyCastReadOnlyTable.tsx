      ...
      <table className="text-xs sm:text-sm divide-y divide-gray-200 w-max">
        <thead className="bg-gray-50">
          <tr className="text-left text-gray-600">
            <th
              rowSpan={2}
              className="p-2 sm:p-3 font-semibold sticky left-0 bg-gray-50 z-20 min-w-[110px] sm:min-w-[130px] border-r border-gray-200 shadow-[2px_0_4px_-2px_rgba(0,0,0,0.08)]"
            >
              キャスト
            </th>
            <th rowSpan={2} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[70px]">
              勤務時間
            </th>
            <th
              colSpan={5}
              className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap border-l-2 border-gray-300 border-r-2 border-gray-300"
            >
              控除
            </th>
            <th
              rowSpan={2}
              className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[80px] border-l-2 border-gray-400"
            >
              ペナルティ
            </th>
            <th rowSpan={2} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px]">
              控除合計
            </th>
            <th rowSpan={2} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[70px]">
              時給
            ...
            <th
              rowSpan={2}
              className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px] border-l-2 border-gray-400"
            >
              ボーナス
            </th>
            <th rowSpan={2} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px]">
            ...
            <th
              rowSpan={2}
              className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[95px] border-r-2 border-gray-300"
            >
              追加ポイント
            </th>
            <th rowSpan={2} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px]">
            ...
            <th
              rowSpan={2}
              className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px] border-l border-gray-200"
            >
              未払い
            </th>
          </tr>
          <tr className="text-left text-gray-600 border-t-2 border-gray-400">
            <th className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px] border-l-2 border-gray-300">
              前借日払
            </th>
            ...
            <th className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[70px] border-r-2 border-gray-300">
              その他
            </th>
            <th className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px] border-l-2 border-gray-300">
              本指名
            ...
            {payrollCategories.map((c) => (
              <th key={c.id} className="p-2 sm:p-3 text-center font-semibold whitespace-nowrap min-w-[90px]">
                {c.name}
              </th>
            ))}
          </tr>
